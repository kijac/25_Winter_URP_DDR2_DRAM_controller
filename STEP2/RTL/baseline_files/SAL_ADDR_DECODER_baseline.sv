...
(
    ...
    seq_num_t                   seq_num,    global_seq_num;
    ...
    always_comb begin
        ...
        if (axi_aw_if.avalid) begin
            ...
            id                          = axi_aw_if.aid;
            len                         = axi_aw_if.alen;
            seq_num                     = global_seq_num; // Unified Sequence
    ...
    always_ff @(posedge clk)
        if (~rst_n) begin
            ...
            if ((axi_ar_if.avalid & axi_ar_if.aready) || (axi_aw_if.avalid & axi_aw_if.aready)) begin
                global_seq_num          <= global_seq_num + 'd1;
            end
        end
